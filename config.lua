...
Config.ReviveReward               = 700  -- revive recompensa, defina como 0 se não quiser que seja ativado
Config.AntiCombatLog              = true -- ativar logging anti-combate?
Config.LoadIpl                    = true -- desativar se você estiver usando fivem-ipl ou outros carregadores de IPL
...
Config.EarlyRespawnTimer          = 2 * minute  -- Tempo até o respawn está disponível
Config.BleedoutTimer              = 10 * minute -- Tempo até o jogador sangrar
